...
Os testes automatizados também cobrem Vida do jogador e de objetos, dano, cura, coleta única, interação consumível, área de morte, eventos de gameplay e serialização desses estados no Memory Card.
